import { FacultyListResponse, FacultyResponse } from '@/types/people';

import { getRequest } from '.';

export const getFacultyList = () => getRequest('/professor/active') as Promise<FacultyListResponse>;
...
export const getMockFacultyList: typeof getFacultyList = async () => {
