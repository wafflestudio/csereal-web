...
export const putGeneralStudies = (data: GeneralStudiesRequirement) =>
  putRequest(`/v2/academics/undergraduate/general-studies-requirements/${data.year}`, {
...
export const deleteGeneralStudies = async (year: number) =>
  deleteRequest(`/v2/academics/undergraduate/general-studies-requirements/${year}`, {
    jsessionID: true,
  });
