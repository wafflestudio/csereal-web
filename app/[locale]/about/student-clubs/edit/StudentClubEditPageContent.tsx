...
const getRequestObject = (
  ...
  return {
    ko: { id: ids.ko, name: content.name.ko, description: content.description.ko, removeImage },
    en: { id: ids.en, name: content.name.en, description: content.description.en, removeImage },
  };
};
