import { Course, CourseChange, Scholarship, ScholarshipList } from '@/types/academics';
...
// export const getMockGeneralStudiesRequirements = async (): Promise<> => {};
...
export const getMockScholarship = async (): Promise<Scholarship> => {
  return {
    id: 1,
    name: '서울대학교 발전기금 장학금(신영길장학금, 현암 김종상장학금, 기타 컴퓨터공학부 지정 장학금 다수)',
