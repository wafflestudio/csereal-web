...
const DegreeRequirementsHTMLData = `
<h2><span id=".EC.BB.B4.ED.93.A8.ED.84.B0.EA.B3.B5.ED.95.99_.EC.A0.84.EA.B3.B5_.ED.95.99.EC.A0.90"></span><span class="mw-headline" id="컴퓨터공학_전공_학점">컴퓨터공학 전공 학점</span></h2>
<h3><span id=".EC.BB.B4.ED.93.A8.ED.84.B0.EA.B3.B5.ED.95.99_.EB.8B.A8.EC.9D.BC_.EC.A0.84.EA.B3.B5_.28.EC.9E.90.EC.9C.A0.EC.A0.84.EA.B3.B5.ED.95.99.EB.B6.80_.EC.A3.BC.EC.A0.84.EA.B3.B5:_.EC.8B.AC.ED.99.94.EC.A0.84.EA.B3.B5_.ED.95.B4.EB.8B.B9.29_https:.2F.2Fcse.snu.ac.kr.2Fnode.2F41275_.EC.B0.B8.EC.A1.B0"></span><span class="mw-headline" id="컴퓨터공학_단일_전공_(자유전공학부_주전공:_심화전공_해당)_https://cse.snu.ac.kr/node/41275_참조">컴퓨터공학 단일 전공 (자유전공학부 주전공: 심화전공 해당) <a rel="nofollow" class="external free" href="https://cse.snu.ac.kr/node/41275">https://cse.snu.ac.kr/node/41275</a> 참조</span></h3>
<ul><li>(2021~2023학번) 전공학점 63학점을 이수: 전필 30학점 + 전선 내규필수 8학점을 포함한 63학점 이수</li></ul>
<p>&nbsp;&nbsp;&nbsp;- 전필: 이산수학(3), 논리설계(4), 컴퓨터프로그래밍(4), 전기전자회로(3), 자료구조(3), 컴퓨터구조(3), 시스템프로그래밍(4), <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;알고리즘(3), 공대 공통교과목(3)<br>
&nbsp;&nbsp;&nbsp;- 전선내규필수: 소프트웨어 개발의 원리와 실습(4), 컴퓨터공학세미나(1) 또는 IT-리더십세미나(1)(세미나는 1과목만 이수), <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;창의적통합설계 1(3) 또는 창의적통합설계 2(3)
</p>
<ul><li>(2020학번) 전공학점 63학점을 이수: 전필 31학점 + 전선 내규필수 8학점을 포함한 63학점 이수</li></ul>
<p>&nbsp;&nbsp;&nbsp;- 전필: 이산수학(3), 논리설계(4), 컴퓨터프로그래밍(4), 전기전자회로(3), 자료구조(4), 컴퓨터구조(3), 시스템프로그래밍(4), <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;알고리즘(3), 공대 공통교과목(3)<br>
&nbsp;&nbsp;&nbsp;- 전선내규필수: 소프트웨어 개발의 원리와 실습(4), 컴퓨터공학세미나(1) 또는 IT-리더십세미나(1)(세미나는 1과목만 이수), <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;창의적통합설계 1(3) 또는 창의적통합설계 2(3)
</p>
<ul><li>(2019학번) 전공학점 63학점을 이수: 전필 35학점 + 전선 내규필수 4학점을 포함한 63학점 이수</li></ul>
<p>&nbsp;&nbsp;&nbsp;- 전필: 이산수학, 논리설계(4학점), 컴퓨터프로그래밍(4학점), 전기전자회로, 자료구조(4학점), 컴퓨터구조, <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;소프트웨어 개발의 원리와 실습(4학점), 시스템프로그래밍(4학점), 알고리즘, 공대 공통교과목<br>
&nbsp;&nbsp;&nbsp;- 내규필수: 컴퓨터공학세미나 또는 IT-리더십세미나(세미나는 1과목만 이수), 창의적통합설계 1 또는 창의적통합설계 2<br>
</p>
<ul><li>(2008~2010학번) 컴퓨터공학 전공 60학점 이상: 전필 33학점 + 내규 5학점을 포함한 60학점 이수</li></ul>
<p>&nbsp;&nbsp;&nbsp;- 전필: 이산수학, 논리설계, 논리설계실험, 컴퓨터프로그래밍, 전기전자회로, 자료구조, 프로그래밍의 원리, 컴퓨터구조, 운영체제, <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;프로그래밍언어, 알고리즘 <br>
&nbsp;&nbsp;&nbsp;- 내규필수: 컴퓨터공학세미나, IT-리더십세미나, 프로젝트1 또는 프로젝트2 <br>
</p>
<ul><li>(2011~2014학번) 컴퓨터공학 전공 63학점 이상: 전필 36학점 + 내규 5학점을 포함한 63학점 이수</li></ul>
<p>&nbsp;&nbsp;&nbsp;- 전필: 이산수학, 논리설계, 논리설계실험, 컴퓨터프로그래밍, 전기전자회로, 자료구조, 프로그래밍의 원리, 컴퓨터구조, 운영체제, <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;프로그래밍언어, 알고리즘, 공대 공통교과목 <br>
&nbsp;&nbsp;&nbsp;- 내규필수: 컴퓨터공학세미나, IT-리더십세미나, 프로젝트1 또는 프로젝트2 <br>
</p>
<ul><li>(2015~2018학번) 컴퓨터공학 전공 63학점 이상: 전필 37학점 + 내규 4학점을 포함한 63학점 이수 <br></li></ul>
<p>&nbsp;&nbsp;&nbsp;- 전필: 이산수학, 논리설계(4학점), 컴퓨터프로그래밍(4학점), 전기전자회로, 자료구조(4학점), 컴퓨터구조, 소프트웨어 개발의 원리와 실제, <br>
&nbsp;&nbsp;&nbsp;   시스템프로그래밍(4학점), 하드웨어시스템설계, 알고리즘, 공대 공통교과목 <br>
&nbsp;&nbsp;&nbsp;- 내규필수: 컴퓨터공학세미나 또는 IT-리더십세미나(세미나는 1과목만 이수), 창의적통합설계 1 또는 창의적통합설계 2
</p>
<h3><span id=".EC.BB.B4.ED.93.A8.ED.84.B0.EA.B3.B5.ED.95.99.EC.9D.84_.EC.A3.BC.EC.A0.84.EA.B3.B5.EC.9C.BC.EB.A1.9C_.ED.95.98.EB.8A.94_.ED.95.99.EC.83.9D.EC.9D.B4_.ED.83.80_.EC.A0.84.EA.B3.B5.EC.9D.84_.EB.B3.B5.EC.88.98.EC.A0.84.EA.B3.B5.2F.EB.B6.80.EC.A0.84.EA.B3.B5.ED.95.A0_.EB.95.8C.28.EC.9E.90.EC.9C.A0.EC.A0.84.EA.B3.B5.ED.95.99.EB.B6.80.EC.97.90.EC.84.9C_.EC.A3.BC.EC.A0.84.EA.B3.B5_2.EA.B0.9C_.EC.9D.B4.EC.83.81_.EC.A4.91_.ED.95.98.EB.82.98.EB.A1.9C_.EC.BB.B4.ED.93.A8.ED.84.B0.EA.B3.B5.ED.95.99.EC.9D.84_.EC.A0.84.EA.B3.B5.ED.95.A0_.EB.95.8C.29_https:.2F.2Fcse.snu.ac.kr.2Fnode.2F41275_.EC.B0.B8.EC.A1.B0"></span><span class="mw-headline" id="컴퓨터공학을_주전공으로_하는_학생이_타_전공을_복수전공/부전공할_때(자유전공학부에서_주전공_2개_이상_중_하나로_컴퓨터공학을_전공할_때)_https://cse.snu.ac.kr/node/41275_참조">컴퓨터공학을 주전공으로 하는 학생이 타 전공을 복수전공/부전공할 때(자유전공학부에서 주전공 2개 이상 중 하나로 컴퓨터공학을 전공할 때) <a rel="nofollow" class="external free" href="https://cse.snu.ac.kr/node/41275">https://cse.snu.ac.kr/node/41275</a> 참조</span></h3>
<ul><li>(2021~2023학번) 컴퓨터공학부의 전공학점을 45학점 이상(복수전공, 연합전공시) / 48학점 이상(부전공, 연계전공시) 이수하고 타 학부에서 정하는 필요학점 이수: 컴퓨터공학부 전필 30학점 + 전선 내규필수 8학점 + 전선 7학점 이상(복수전공, 연합전공시) / 컴퓨터공학부 전필 30학점 + 전선 내규필수 8학점 + 전선 10학점 이상(부전공, 연계전공시)<br></li></ul>
<p>&nbsp;&nbsp;&nbsp;- 전필: 이산수학(3), 논리설계(4), 컴퓨터프로그래밍(4), 전기전자회로(3), 자료구조(3), 컴퓨터구조(3), 시스템프로그래밍(4), <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;알고리즘(3), 공대 공통교과목(3) <br>
&nbsp;&nbsp;&nbsp;- 전선내규필수: 소프트웨어 개발의 원리와 실습(4), 컴퓨터공학세미나(1) 또는 IT-리더십세미나(1)(세미나는 1과목만 이수), <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;창의적통합설계 1(3) 또는 창의적통합설계 2(3)
</p>
<ul><li>(2020학번) 컴퓨터공학부의 전공학점을 45학점 이상(복수전공, 연합전공시) / 48학점 이상(부전공, 연계전공시) 이수하고 타 학부에서 정하는 필요학점 이수: 컴퓨터공학부 전필 31학점 + 전선 내규필수 8학점 + 전선 6학점 이상(복수전공, 연합전공시) /  컴퓨터공학부 전필 31학점 + 전선 내규필수 8학점 + 전선 9학점 이상(부전공, 연계전공시)<br></li></ul>
<p>&nbsp;&nbsp;&nbsp;- 전필: 이산수학(3), 논리설계(4), 컴퓨터프로그래밍(4), 전기전자회로(3), 자료구조(4), 컴퓨터구조(3), 시스템프로그래밍(4), <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;알고리즘(3), 공대 공통교과목(3) <br>
&nbsp;&nbsp;&nbsp;- 전선내규필수: 소프트웨어 개발의 원리와 실습(4), 컴퓨터공학세미나(1) 또는 IT-리더십세미나(1)(세미나는 1과목만 이수), <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;창의적통합설계 1(3) 또는 창의적통합설계 2(3)
</p>
<ul><li>(2019학번) 컴퓨터공학부의 전공학점을 41학점 이상 이수하고 타 학부에서 정하는 필요학점 이수: 컴퓨터공학부 전필 35학점 + 전선 내규필수 4학점 + 전선 2학점이상</li></ul>
<p>&nbsp;&nbsp;&nbsp;- 전필: 이산수학, 논리설계(4학점), 컴퓨터프로그래밍(4학점), 전기전자회로, 자료구조(4학점), 컴퓨터구조, <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;소프트웨어 개발의 원리와 실습(4학점), 시스템프로그래밍(4학점), 알고리즘, 공대 공통교과목<br>
&nbsp;&nbsp;&nbsp;- 내규필수: 컴퓨터공학세미나 또는 IT-리더십세미나(세미나는 1과목만 이수), 창의적통합설계 1 또는 창의적통합설계 2
</p>
<ul><li>(2008~2010학번) 컴퓨터공학부의 전공학점을 39학점 이상 이수하고 타 학부에서 정하는 필요학점 이수</li></ul>
<p>&nbsp;&nbsp;&nbsp;- 전필: 이산수학, 논리설계, 논리설계실험, 컴퓨터프로그래밍, 전기전자회로, 자료구조, 프로그래밍의 원리, 컴퓨터구조, 운영체제, <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;프로그래밍언어, 알고리즘<br>
&nbsp;&nbsp;&nbsp;- 내규필수: 컴퓨터공학세미나, IT-리더십세미나, 프로젝트1 또는 프로젝트2
</p>
<ul><li>(2011~2014학번) 컴퓨터공학부의 전공학점을 41학점 이상 이수하고 타 학부에서 정하는 필요학점 이수</li></ul>
<p>&nbsp;&nbsp;&nbsp;- 전필: 이산수학, 논리설계, 논리설계실험, 컴퓨터프로그래밍, 전기전자회로, 자료구조, 프로그래밍의 원리, 컴퓨터구조, 운영체제, <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;프로그래밍언어, 알고리즘, 공대 공통교과목<br>
&nbsp;&nbsp;&nbsp;- 내규필수: 컴퓨터공학세미나, IT-리더십세미나, 프로젝트1 또는 프로젝트2
</p>
<ul><li>(2015~2018학번) 컴퓨터공학부의 전공학점을 41학점 이상 이수하고 타 학부에서 정하는 필요학점 이수</li></ul>
<p>&nbsp;&nbsp;&nbsp;- 전필: 이산수학, 논리설계(4학점), 컴퓨터프로그래밍(4학점), 전기전자회로, 자료구조(4학점), 컴퓨터구조, 소프트웨어 개발의 원리와 실제, <br>
&nbsp;&nbsp;&nbsp;   시스템프로그래밍(4학점), 하드웨어시스템설계, 알고리즘, 공대 공통교과목<br>
&nbsp;&nbsp;&nbsp;- 내규필수: 컴퓨터공학세미나 또는 IT-리더십세미나(세미나는 1과목만 이수), 창의적통합설계 1 또는 창의적통합설계 2
</p>
<h3><span id=".EC.BB.B4.ED.93.A8.ED.84.B0.EA.B3.B5.ED.95.99_.EB.B3.B5.EC.88.98.EC.A0.84.EA.B3.B5.2C_.ED.83.80_.EC.A0.84.EA.B3.B5_.EC.A3.BC.EC.A0.84.EA.B3.B5_.28.EC.BB.B4.ED.93.A8.ED.84.B0.EA.B3.B5.ED.95.99.EB.B6.80.EA.B0.80_.EC.95.84.EB.8B.8C_.EB.8B.A4.EB.A5.B8_.ED.95.99.EA.B3.BC_.ED.95.99.EC.83.9D.EC.9D.B4_.EC.BB.B4.ED.93.A8.ED.84.B0_.EA.B3.B5.ED.95.99.EC.9D.84_.EB.B3.B5.EC.88.98.EC.A0.84.EA.B3.B5.ED.95.A0_.EB.95.8C.29"></span><span class="mw-headline" id="컴퓨터공학_복수전공,_타_전공_주전공_(컴퓨터공학부가_아닌_다른_학과_학생이_컴퓨터_공학을_복수전공할_때)">컴퓨터공학 복수전공, 타 전공 주전공 (컴퓨터공학부가 아닌 다른 학과 학생이 컴퓨터 공학을 복수전공할 때)</span></h3>
<ul><li>(2021~2023학번) 컴퓨터공학 전공 39학점 이상 (공대 공통 교과목 제외): 전필 27학점 + 전선 12학점이상</li></ul>
<p>&nbsp;&nbsp;&nbsp;- 전필: 이산수학(3), 논리설계(4), 컴퓨터프로그래밍(4), 전기전자회로(3), 자료구조(3), 컴퓨터구조(3), 시스템프로그래밍(4), <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;알고리즘(3)<br>
&nbsp;&nbsp;&nbsp;- 내규필수: 면제<br>
</p>
<ul><li>(2020학번) 컴퓨터공학 전공 39학점 이상 (공대 공통 교과목 제외): 전필 28학점 + 전선 11학점이상</li></ul>
<pre>  <a rel="nofollow" class="external free" href="https://cse.snu.ac.kr/node/35308">https://cse.snu.ac.kr/node/35308</a>, <a rel="nofollow" class="external free" href="https://cse.snu.ac.kr/node/41275">https://cse.snu.ac.kr/node/41275</a>  참조<br>
</pre>
<p>&nbsp;&nbsp;&nbsp;- 전필: 이산수학(3), 논리설계(4), 컴퓨터프로그래밍(4), 전기전자회로(3), 자료구조(4), 컴퓨터구조(3), 시스템프로그래밍(4), <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;알고리즘(3)<br>
&nbsp;&nbsp;&nbsp;- 내규필수: 면제<br>
</p>
<ul><li>(2019학번) 컴퓨터공학 전공 39학점 이상 (공대 공통 교과목 제외) / <a rel="nofollow" class="external free" href="https://cse.snu.ac.kr/node/35308">https://cse.snu.ac.kr/node/35308</a> 참조</li></ul>
<p>&nbsp;&nbsp;&nbsp;- 전필: 이산수학, 논리설계(4학점), 컴퓨터프로그래밍(4학점), 전기전자회로, 자료구조(4학점), 컴퓨터구조, <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;소프트웨어 개발의 원리와 실습(4학점), 시스템프로그래밍(4학점), 알고리즘<br>
&nbsp;&nbsp;&nbsp;- 내규필수: 면제
</p>
<ul><li>07학번까지&nbsp;: 컴퓨터공학 전공 51학점 이상 (공대 공통 교과목 포함)</li></ul>
<p>&nbsp;&nbsp;&nbsp;- 전필: 이산수학, 논리설계, 논리설계실험, 컴퓨터프로그래밍, 전기전자회로, 자료구조, 프로그래밍의 원리, 컴퓨터구조, 운영체제, <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;프로그래밍언어, 알고리즘, 공대 공통교과목<br>
&nbsp;&nbsp;&nbsp;- 내규필수: 컴퓨터공학세미나, IT-리더십세미나, 프로젝트1 또는 프로젝트
</p>
<ul><li>(2008~2014학번) 컴퓨터공학 전공 39학점 이상 (공대 공통 교과목 제외)</li></ul>
<p>&nbsp;&nbsp;&nbsp;- 전필: 이산수학, 논리설계, 논리설계실험, 컴퓨터프로그래밍, 전기전자회로, 자료구조, 프로그래밍의 원리, 컴퓨터구조, 운영체제, <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;프로그래밍언어, 알고리즘<br>
&nbsp;&nbsp;&nbsp;- 내규필수: 컴퓨터공학세미나, IT-리더십세미나, 프로젝트1 또는 프로젝트2
</p>
<ul><li>(2015~2018학번) 컴퓨터공학 전공 39학점 이상 (공대 공통 교과목 제외)</li></ul>
<p>&nbsp;&nbsp;&nbsp;- 전필: 이산수학, 논리설계(4학점), 컴퓨터프로그래밍(4학점), 전기전자회로, 자료구조(4학점), 컴퓨터구조, 소프트웨어 개발의 원리와 실제, <br>
&nbsp;&nbsp;&nbsp;시스템프로그래밍(4학점), 하드웨어시스템설계, 알고리즘<br>
&nbsp;&nbsp;&nbsp;- 내규필수: 컴퓨터공학세미나 또는 IT-리더십세미나(세미나는 1과목만 이수), 창의적통합설계 1 또는 창의적통합설계 2
</p>
<h3><span id=".EC.BB.B4.ED.93.A8.ED.84.B0.EA.B3.B5.ED.95.99_.EB.B6.80.EC.A0.84.EA.B3.B5.2C_.ED.83.80_.EC.A0.84.EA.B3.B5_.EC.A3.BC.EC.A0.84.EA.B3.B5_.28.EC.BB.B4.ED.93.A8.ED.84.B0_.EA.B3.B5.ED.95.99.EB.B6.80.EA.B0.80_.EC.95.84.EB.8B.8C_.EB.8B.A4.EB.A5.B8_.ED.95.99.EA.B3.BC_.ED.95.99.EC.83.9D.EC.9D.B4_.EC.BB.B4.ED.93.A8.ED.84.B0_.EA.B3.B5.ED.95.99.EC.9D.84_.EB.B6.80.EC.A0.84.EA.B3.B5.ED.95.A0_.EB.95.8C.29"></span><span class="mw-headline" id="컴퓨터공학_부전공,_타_전공_주전공_(컴퓨터_공학부가_아닌_다른_학과_학생이_컴퓨터_공학을_부전공할_때)">컴퓨터공학 부전공, 타 전공 주전공 (컴퓨터 공학부가 아닌 다른 학과 학생이 컴퓨터 공학을 부전공할 때)</span></h3>
<ul><li>07학번까지&nbsp;: 컴퓨터공학 전공 <b>24학점 이상</b>  -&gt; 전필 (자료구조, 시스템프로그래밍, 컴퓨터구조) 교과목을 포함하여 총 24학점 이상 이수</li>
<li>08학번부터&nbsp;: 컴퓨터공학 전공 <b>21학점 이상</b> -&gt; 전필 (자료구조, 시스템프로그래밍, 컴퓨터구조)  교과목을 포함하여 총 21학점 이상 이수</li></ul>
<h2><span id=".EC.83.9D.EB.AA.85.EC.A1.B4.EC.A4.91.28.EC.9E.90.EC.82.B4.EC.98.88.EB.B0.A9.29_.EA.B5.90.EC.9C.A1_.EC.9D.B4.EC.88.98_.EC.9D.98.EB.AC.B4"></span><span class="mw-headline" id="생명존중(자살예방)_교육_이수_의무">생명존중(자살예방) 교육 이수 의무</span></h2>
<p>2016학년도 공과대학 신입생부터는 서울대학교 공과대학 생명존중(자살예방) 교육 이수가 졸업 필수 조건이므로 반드시 입학년도 첫 학기에 이수 후 이수증 사본을 컴퓨터공학부 행정실에 제출해야 한다. (컴퓨터공학부 필수 이수 대상자: 학부생 2016 ~ 2023학번)
</p>
<h2><span id=".EC.99.B8.EA.B5.AD.EC.96.B4.EC.A7.84.ED.96.89.EA.B0.95.EC.A2.8C_.EC.88.98.EA.B0.95_.EC.9D.98.EB.AC.B4"></span><span class="mw-headline" id="외국어진행강좌_수강_의무">외국어진행강좌 수강 의무</span></h2>
<p>2008학년도 신입생부터는 1과목 이상의 전공교과목을 포함하여 3과목 이상의 외국어진행강좌를 수강해야 한다.
(2012학번부터는 대학영어 제외)
</p>
<h2><span id=".ED.95.99.EC.A0.90"></span><span class="mw-headline" id="학점">학점</span></h2>
<p>재학 중 이수한 전 교과목 및 전공 교과목의 성적 평점평균이 각각 C0(2.0)이상이어야 졸업할 수 있다.
</p>
<h2><span id=".EC.A0.84.ED.95.84_.EA.B5.90.EA.B3.BC.EB.AA.A9"></span><span class="mw-headline" id="전필_교과목">전필 교과목</span></h2>
<ul><li>(2008~2014학번) 이산수학, 논리설계, 논리설계실험, 컴퓨터프로그래밍, 전기전자회로, 자료구조, 프로그래밍의 원리, 컴퓨터구조, 운영체제, 프로그래밍언어, 알고리즘</li>
<li>(2015~2018학번) 이산수학, 논리설계(4학점), 컴퓨터프로그래밍(4학점), 전기전자회로, 자료구조(4학점), 컴퓨터구조, 소프트웨어 개발의 원리와 실제, 시스템프로그래밍(4학점), 하드웨어시스템설계, 알고리즘</li></ul>
<h2><span id=".EA.B3.B5.EA.B3.BC.EB.8C.80.ED.95.99_.EA.B3.B5.ED.86.B5_.EA.B5.90.EA.B3.BC.EB.AA.A9"></span><span class="mw-headline" id="공과대학_공통_교과목">공과대학 공통 교과목</span></h2>
<ul><li>주전공 (2021~2023학번) <br> <a rel="nofollow" class="external free" href="https://cse.snu.ac.kr/node/59168">https://cse.snu.ac.kr/node/59168</a> 참고</li></ul>
<p>&nbsp;&nbsp;&nbsp;- 공과대학 공통과목 전 영역에서 3학점을 필수로 이수하여야 함 <br>
&nbsp;&nbsp;&nbsp;- 400.XXX 또는 M2177.XXXXXXX 과목은 최대 9학점까지 인정(정보통신융합 및 딥러닝의 기초는 9학점 제한에서 제외)
</p>
<ul><li>주전공 (2011 ~ 2019학번)</li></ul>
<p>&nbsp;&nbsp;&nbsp;- 기계공학개론(400.013), 산업공학개론(400.015), 재료공학개론(400.020) 건설환경공학개론(400.022), 화학생물공학개론(400.023), 에너지자원공학개론(400.024) 중 택일 
</p>
<ul><li>주전공 (2008 ~ 2010학번)</li></ul>
<p>&nbsp;&nbsp;&nbsp;- 해당없음 
</p>
<ul><li>복수전공 (2008 ~2020학번)</li></ul>
<p>&nbsp;&nbsp;&nbsp;- 해당없음
</p>
<ul><li>복수전공 (~ 2007학번까지)</li></ul>
<p>&nbsp;&nbsp;&nbsp;- 기계공학개론(400.013), 산업공학개론(400.015), 전기공학개론(400.019), 재료공학개론 (400.020) 중 택일 
</p>
<h2><span id=".EB.82.B4.EA.B7.9C_.EA.B5.90.EA.B3.BC.EB.AA.A9"></span><span class="mw-headline" id="내규_교과목">내규 교과목</span></h2>
<ul><li>컴퓨터공학세미나 (1학점)</li>
<li>IT-리더십세미나 (1학점)</li>
<li>프로젝트1 (3학점) 또는 프로젝트2 (3학점)</li></ul>
<p>이상 총 5학점.
</p>
<h2><span id=".EA.B3.BC.EA.B1.B0_.ED.95.99.EB.B2.88_.ED.95.99.EC.83.9D.EB.93.A4.EC.9D.84_.EC.9C.84.ED.95.9C_.EA.B2.BD.EA.B3.BC.EC.A1.B0.EC.B9.98"></span><span class="mw-headline" id="과거_학번_학생들을_위한_경과조치">과거 학번 학생들을 위한 경과조치</span></h2>
<h3><span id=".EC.BB.B4.ED.93.A8.ED.84.B0.EA.B3.B5.ED.95.99.EC.84.B8.EB.AF.B8.EB.82.98.2C_IT-.EB.A6.AC.EB.8D.94.EC.8B.AD.EC.84.B8.EB.AF.B8.EB.82.98_.EA.B5.90.EA.B3.BC.EB.AA.A9"></span><span class="mw-headline" id="컴퓨터공학세미나,_IT-리더십세미나_교과목">컴퓨터공학세미나, IT-리더십세미나 교과목</span></h3>
<ul><li>2015 ~ 2020학번: 컴퓨터공학세미나 또는 IT-리더십세미나 중 택일</li>
<li>2006 ~ 2014학번: 컴퓨터공학세미나 및 IT-리더십세미나 모두 수강</li>
<li>2002 ~ 2005학번: 컴퓨터공학세미나 또는 IT-리더십세미나 중 택일</li></ul>
<h3><span id=".ED.94.84.EB.A1.9C.EC.A0.9D.ED.8A.B8_.EA.B5.90.EA.B3.BC.EB.AA.A9"></span><span class="mw-headline" id="프로젝트_교과목">프로젝트 교과목</span></h3>
<ul><li>1999학번부터: 프로젝트1 (설계프로젝트1, 창의적통합설계1) 또는 프로젝트2 (설계프로젝트2, 창의적통합설계2) 중 택일</li>
<li>1998학번까지: 프로젝트1 (설계프로젝트1) 및 프로젝트2 (설계프로젝트2) 모두 수강</li>
<li>(예외) (구)전산과학과에서 소속을 변경한 학생은 프로젝트1 및 프로젝트 2를 수강하지 않아도 된다.</li></ul>
<h3><span id=".EA.B5.90.EC.96.91_.EB.8C.80.ED.95.99.EC.98.81.EC.96.B4_.28.EB.8C.80.ED.95.99.EC.98.81.EC.96.B41.2C_.EB.8C.80.ED.95.99.EC.98.81.EC.96.B42.2C_.EA.B3.A0.EA.B8.89.EC.98.81.EC.96.B4.29_.EA.B5.90.EA.B3.BC.EB.AA.A9"></span><span class="mw-headline" id="교양_대학영어_(대학영어1,_대학영어2,_고급영어)_교과목">교양 대학영어 (대학영어1, 대학영어2, 고급영어) 교과목</span></h3>
<p>2008학번을 포함한 그 이전 학생이 대학영어 또는 고급영어를 수강할 경우 (재수강 포함), 대학영어 과목의 학점 변경 (3학점에서 2학점으로 변경)으로 인해 학문의 기초에서 이수학점을 충족하지 못하더라도 학문의 기초 최저이수학점을 이수한 것으로 인정한다. 단 전체 교양 최저이수학점은 충족해야 한다.
</p>
<h2><span id=".EC.A1.B8.EC.97.85.EB.85.BC.EB.AC.B8"></span><span class="mw-headline" id="졸업논문">졸업논문</span></h2>
<p>학부생은 논문 지도교수의 허락을 받을 경우 아래의 내용으로 졸업논문을 대체할 수 있다. 
단, 졸업논문 형식의 보고서를 작성하여 제출하여야 한다.
</p>
<ol><li>프로젝트 과목의 결과물 (교과목명 변경: 프로젝트=창의적통합설계)
<ol><li>프로젝트 1 과목과 프로젝트 2 과목을 모두 이수한 학생에 한한다.</li>
<li>논문은 제출자가 프로젝트 팀 내에서 다른 구성원이 아닌 자신이 직접 수행한 것을 바탕으로 작성하여야 한다. 다른 구성원의 업적을 개인의 업적인 양 제출하는 것은 연구윤리 위반에 해당하므로 졸업사정에서 제외한다.</li>
<li>프로젝트의 팀원이 결과를 중복하여 각각 개인의 업적으로 제출할 수 없다. 중복이 발견될 경우에 중복에 관련된 전원의 졸업논문을 인정하지 않는다.</li></ol></li>
<li>Open S/W를 등록한 내용</li>
<li>AppStore 등 사이트에 등록한 내용</li>
<li>회사에서 근무하거나 인턴으로 했던 작업의 내용</li>
<li>저널이나 컨퍼런스에 저자로 논문이 게재확정 되거나 게재된 내용</li>
<li>스타트업을 창업하여 본인이 회사에 기여한 내용</li></ol>
<p>※ 회사에서 근무하거나 인턴으로 했던 작업의 내용으로 졸업논문을 작성시 본인의 논문내용이 특정회사와 관련된 경우 회사 담당자로부터 학부논문 제출 동의서를 회사에서 받은 후 컴퓨터공학부 행정실로 제출해야 함.
</p>
<h2><span id=".ED.95.99.EB.B2.88.EB.B3.84_.ED.95.84.EC.88.98_.EA.B5.90.EA.B3.BC.EB.AA.A9"></span><span class="mw-headline" id="학번별_필수_교과목">학번별 필수 교과목</span></h2>
`;

export const DegreeRequirementsData: DegreeRequirements[] = [
  {
    id: 1,
    description: DegreeRequirementsHTMLData,
    year: 2023,
    attachment: {
