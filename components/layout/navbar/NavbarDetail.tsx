...
export default function NavbarDetail({ segmentNode }: { segmentNode: SegmentNode }) {
  ...
  return (
    <div className="bg-[rgba(22,_22,_22,_0.97)] backdrop-blur-[2px] pt-[9.63rem] pl-[3.75rem] w-[22rem] overflow-x-hidden overflow-y-scroll no-scrollbar absolute left-44 top-0 bottom-0 z-50">
