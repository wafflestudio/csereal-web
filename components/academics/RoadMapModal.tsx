...
export default function RoadMapModal({ onClose }: { onClose: () => void }) {
  return (
    <ModalFrame onClose={onClose}>
      <div className="relative flex flex-col gap-4 p-6 w-fit bg-neutral-100 border-t-2 border-b rounded-t-sm border-main-orange overflow-auto styled-scrollbar overflow-x-hidden">
        <RoadMapTitle />
        <RoadMapDescription />
        <RoadMap />
...
function RoadMapDescription() {
  return (
    <p className="w-[70vw] max-w-[45rem] text-sm text-neutral-700 leading-loose">
...
function RoadMap() {
  return <div className="h-[430px] min-h-[15rem] bg-neutral-300"></div>;
}
